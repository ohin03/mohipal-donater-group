...
const DonorList = () => {
  ...
  return (
    <div style={{ padding: "40px", background: "#fff0f0", minHeight: "100vh", marginTop: "50px" }}>
      <h2 style={{ textAlign: "center", marginBottom: "30px", color: "#b71c1c" }}>
        🩸 All Blood Donors
      </h2>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", justifyContent: "center" }}>
        {filteredDonors.map(donor => (
          ...
          >
            ...
            <h3 style={{ marginTop: "10px", color: "#b71c1c", fontSize: "18px" }}>{donor.name}</h3>
            <p style={{ margin: "5px 0" }}>Blood Group: <strong>{donor.bloodGroup}</strong></p>
